...
<body>
    <header>
        <nav class="navigation">
         <!-- <a href="#" class="logo1"> BEATS</a> -->
         <a href="login-figma-style.php" class="logo">Login </a>
            <div class="menu">
            <span class="bar"></span>
            <span class="bar"></span>
            <span class="bar"></span>
    ...
    <main>
        <section class="home">
            <div class="home-text">
                ...
                <br>
                <br>
                <a href="register.php" class="home-btn">Crie sua conta</a>
            </div>
            <div class="home-img">
                <img src="beats_img.png" alt="Beats">
            </div>
        </section>
</body>
</html>